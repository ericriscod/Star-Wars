    ...
    try {
        select.addEventListener('change', () => {
            ...
            if (obj) {
                ...
                createAndAppendElement('dt', 'Cargo capacity: ')
                ...
                createAndAppendElement('dt', 'Vehicle class: ')
                createAndAppendElement('dd', obj.vehicle_class)
...
fetchDetails('https://swapi.dev/api/vehicles/')
